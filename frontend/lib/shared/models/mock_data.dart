...
class MockData {
  static final UserModel currentUser = UserModel(
    ...
    yearOfStudy: 3,
    skills: ['Flutter', 'UI/UX', 'Research', 'Public Speaking', 'Leadership'],
    interests: ['Hackathons', 'Peer Study', 'Tech Society'],
    leadershipPoints: 340,
    eventsHosted: 3,
    eventsAttended: 12,
    badges: ['Collaborator', 'Innovator'],
    joinedClanIds: ['clan_001', 'clan_003'],
    joinedTeamIds: ['team_003'],
